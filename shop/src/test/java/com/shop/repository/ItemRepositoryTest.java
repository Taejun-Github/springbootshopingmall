...
class ItemRepositoryTest {
    ...
    @Test
    @DisplayName("QueryDsl 조희 테스트1")
    public void queryDslTest() {
        this.createItemList();
        JPAQueryFactory queryFactory = new JPAQueryFactory(em); // 영속성 컨텍스트를 사용하기 위해서 @PersistenceContext 어노테이션을 이용해서 EntityManager 빈을 주입한다.
